...
> Need the one-page version to hand a provider (or their agent)? See
> **[Onboard — the brief](onboard.md)** — the same path, condensed, with the exact
> handover and links back here.
